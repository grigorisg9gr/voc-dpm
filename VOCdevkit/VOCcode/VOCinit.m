...
VOCopts.annopath=['/Annotations/%s.xml'];
VOCopts.imgpath=['/JPEGImages/%s.jpg'];
VOCopts.imgsetpath=['/ImageSets/Main/%s.txt'];
VOCopts.clsimgsetpath=['/ImageSets/Main/%s_%s.txt'];
VOCopts.clsrespath=['Main/%s_cls_' VOCopts.testset '_%s.txt'];
VOCopts.detrespath=['Main/%s_det_' VOCopts.testset '_%s.txt'];
